...
<section id="contact">
  ...
  {/* <!-- Left contact page -->  */}
    ...
    <form id="contact-form" className="form-horizontal" role="form" action="http://localhost:3000/submit-form" method="POST">
  ...
  {/* <!-- Left contact page -->  */}
      ...
      <div className="direct-contact-container">
        ...
        <ul className="contact-list">
          ...
          <li className="list-item"><i className="fa fa-envelope fa-2x"><span className="contact-text gmail"><a href="mailto:#" title="Send me an email">hotelBook@gmail.com</a></span></i></li>
